-- ============================================================================
-- MANUAL MIGRATION FOR LOVABLE SUPPORT
-- Voice Assistant Feature - Database Schema Updates
-- ============================================================================
-- These migrations are in the repo but haven't been applied automatically.
-- Please run this SQL in the Supabase database for the ordersnapr project.
-- ============================================================================
...
-- 2. Add last_username_change column to profiles table
...
-- 3. Update set_username function to enforce 7-day cooldown
...
-- Expected: 1 row with column_name = 'openai_api_key', data_type = 'text'

-- Check if last_username_change column exists
SELECT column_name, data_type, is_nullable
FROM information_schema.columns
WHERE table_name = 'profiles'
AND column_name = 'last_username_change';
-- Expected: 1 row with column_name = 'last_username_change', data_type = 'timestamp with time zone'

-- ============================================================================
-- After running this migration:
-- ✅ API keys will save to database and persist across logout/login
-- ✅ Username changes will be limited to once per 7 days
-- ✅ The Migration Status component in the app will show "✅ Migrations Applied"
-- ============================================================================
